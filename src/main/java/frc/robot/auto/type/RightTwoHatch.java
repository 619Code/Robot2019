...
public class RightTwoHatch extends CommandGroup{
    ...
    public RightTwoHatch(){
        ...
        addSequential(new FollowPath(Paths.RIGHTFIRSTHATCH, Speeds.setSpeed(0.5)));
        Robot.sunKist.resetNavX();
        ...
        Robot.sunKist.resetNavX();
        addSequential(new FollowPath(Paths.RIGHTINTAKEHATCH, Speeds.setSpeed(0.5)));
        addSequential(new TeleAlign());
        ...
        Robot.sunKist.resetNavX();
        addSequential(new FollowPath(Paths.RIGHTSECONDHATCH, Speeds.setSpeed(0.5)));
    }
}